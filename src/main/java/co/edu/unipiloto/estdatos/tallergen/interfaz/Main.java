...
import co.edu.unipiloto.estdatos.tallergen.mundo.nuevaClase;
import co.edu.unipiloto.estdatos.tallergen.mundo.nuevaClase.SistemaOperativo;
...
public class Main {
    ...
    public void agregarComputador() throws Exception {
        ...
        SistemaOperativo[] SistemaOperativos = SistemaOperativo.values();

        for (int i = 0; i < SistemaOperativos.length; i++) {
            System.out.println("[" + (i + 1) + "] " + SistemaOperativos[i]);
        }
        int indice = Integer.parseInt(br.readLine());

        SistemaOperativo SistemaOperativo = SistemaOperativos[indice - 1];
        ...
        Producto nuevaClase = new nuevaClase(gama, precio, SistemaOperativo);

        int respuesta = casilleros.almacenar(nuevaClase);
        if (respuesta != -1) {
            System.out.println("El celular  ha sido almacenada en el casillero " + respuesta);
        } else {
            System.out.println("No hay casilleros disponibles para almacenar la compra");
        }
        System.out.println("::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::");
